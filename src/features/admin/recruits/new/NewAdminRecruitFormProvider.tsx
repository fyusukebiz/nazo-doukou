...
export type NewAdminRecruitFormSchema = z.infer<typeof schema>;

export const useNewAdminRecruitFormContext = () =>
  useFormContext<NewAdminRecruitFormSchema>();
...
export const NewAdminRecruitFormProvider = ({ children }: Props) => {
  const methods = useForm<NewAdminRecruitFormSchema>({
    mode: "onSubmit",
