...
import { AdminRecruits } from "@/features/admin/recruits/list/AdminRecruits";
...
const AdminRecruitsPage: NextPageWithLayout = () => {
  return <AdminRecruits />;
};

AdminRecruitsPage.getLayout = (page) => {
  return (
    <FirebaseAuthGuard>
      <Layout>{page}</Layout>
    </FirebaseAuthGuard>
...
export default AdminRecruitsPage;
